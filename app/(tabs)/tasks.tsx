...
export default function TasksScreen() {
  ...
  // after the modal window is fully removed from Android's view hierarchy.
  ...
  const handleConfirmComplete = useCallback(() => {
    ...
    //    after the modal window is fully gone — fixes Android delay).
  ...
  // On Android this is the earliest safe moment to fire confetti — the modal
  // window has been removed so the confetti canvas is no longer occluded.
  const handleModalDismiss = useCallback(() => {
    if (pendingConfettiAction.current) {
      console.log('🎉 CONFETTI FIRED after modal dismissed', pendingConfettiAction.current.taskId);
