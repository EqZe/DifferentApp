      ...
      <Animated.View style={{ flex: 1 }} entering={FadeIn.duration(250)}>
            ...
            {daysWithEvents.map((day, index) => {
              ...
              return (
                <AnimatedTouchable
                  ...
                  onPress={() => {
                    console.log('ScheduleScreen: Selected day pill', index);
        ...
        <FlatList
          ...
          onMomentumScrollEnd={(e) => {
            ...
            console.log('ScheduleScreen: Pager swiped to day', newIndex);
                ...
                <Animated.View style={styles.heroCard} entering={FadeInDown.delay(50).springify()}>
                  ...
                  >
                    <View style={styles.heroTopRow}>
                      <Text style={styles.heroDayOfWeek}>{dayFullName}</Text>
                      {dayHasAgent && (
                        <View style={styles.heroAgentPill}>
                          <View style={styles.heroAgentDot} />
                          <Text style={styles.heroAgentText}>{dayAgentText}</Text>
                        </View>
                      )}
                    </View>
