...
export default function CalculatorScreen() {
  ...
  console.log('CalculatorScreen: Loading savings calculator webview');
        ...
        <View style={styles.webviewContainer}>
          {Platform.OS === 'web' ? (
            ...
            <WebView
              ...
              onLoadStart={() => {
                console.log('WebView: Started loading calculator');
                setLoading(true);
              }}
              onLoadEnd={() => {
                console.log('WebView: Finished loading calculator');
                setLoading(false);
              }}
